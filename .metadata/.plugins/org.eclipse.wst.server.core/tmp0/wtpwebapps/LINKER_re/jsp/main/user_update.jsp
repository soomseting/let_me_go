...
<body>
    <section>
        ...
        <div class="sign_up_content">
            ...
            <form action="/LINKER/modifyOrDelete.users" method="post" name="action_form">
                <div class="su_con_wrap">
                    ...
                    <div class="su_con_box su_con_for">
                        <!-- 수정하기 버튼 -->
                        <div class="su_input sui1"><button type="button" id="update" class="up_btn" onclick="some()" >수정하기</button></div>
                        <!-- 탈퇴하기 버튼 -->
                        <div class="su_input sui2"><button type="button" id="delete" class="de_btn" onclick="some()" >탈퇴하기</button></div>
                    </div>
	...
	function some(){
		if(event.target.id==="update"){
			document.action_form.action="/LINKER/modify.users";
		}else if(event.target.id==="delete"){
			document.action_form.action="/LINKER/delete.users";
		}
